...
class WindowAttention(nn.Module):
    ...
    def forward(self, x, mask):
        ...
        relative_position_index = self.relative_position_index[:n, :n].reshape(-1)
        relative_position_index = relative_position_index.to(x.device)

        relative_position_bias = self.relative_position_bias_table[relative_position_index].reshape(n, n, -1)
...
class SwinTransformer_3(nn.Module):
    def __init__(
        self,
        in_chans: int,
        embed_dim: int,
